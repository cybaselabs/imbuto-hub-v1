            ...
            >
              {partners.map((partner) => (
                <StaggerItem key={partner.name}>
                  <div
                    className="flex min-h-[120px] items-center justify-center rounded-[26px] bg-white p-5 shadow-sm ring-1 ring-slate-200/80 transition hover:-translate-y-1 hover:shadow-md"
                    title={partner.name}
                  >
                    <img
                      src={partner.logo}
