  ...
  return (
    <footer className="relative overflow-hidden bg-[#062f3c] text-white">
      ...
      <Reveal className="relative mx-auto max-w-7xl px-6 pb-8 pt-20">
        <div className="grid gap-8 xl:grid-cols-[1.2fr_1.8fr]">
          ...
          >
            <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm text-white/80">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#E16A3D] text-sm font-bold text-white">
                IH
              </div>
              Imbuto Foundation
            </div>
            <h3 className="mt-6 max-w-md text-4xl font-semibold leading-tight tracking-[-0.04em] text-white">
            ...
            <p className="mt-5 max-w-lg text-base leading-8 text-white/72">
              ...
              and families access learning, wellbeing, creativity, mentorship,
              and opportunity across Rwanda.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <button className="rounded-full bg-[#E16A3D] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-[#E16A3D]/25 transition hover:-translate-y-0.5 hover:bg-[#cf5d34]">
                Find a Hub
              </button>
              <button className="rounded-full border border-white/15 bg-white/10 px-5 py-3 text-sm font-semibold text-white backdrop-blur-md transition hover:bg-white/15">
                Get Involved
              </button>
            </div>
          </Reveal>
          ...
          <div>
            ...
            >
              {[
                ...
                <StaggerItem
                  key={group.title}
                  className={idx === 2 ? "sm:col-span-2 xl:col-span-1" : ""}
                >
                  <div className="rounded-[28px] border border-white/10 bg-white/5 p-7 backdrop-blur-sm">
                    <div className="text-sm font-medium uppercase tracking-[0.28em] text-[#FFA45D]">
                      {group.title}
                    </div>
            ...
            <Reveal
              delay={0.22}
              className="mt-6 rounded-[32px] border border-white/10 bg-white/5 p-6 backdrop-blur-sm md:flex md:items-center md:justify-between"
            >
              <div>
                <div className="text-sm font-medium uppercase tracking-[0.28em] text-[#FFA45D]">
                  Connect
        ...
        <Reveal
          delay={0.28}
          className="mt-10 overflow-hidden rounded-[28px] border border-white/10 bg-white/5 px-5 py-4 backdrop-blur-sm"
        >
